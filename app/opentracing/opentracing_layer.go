...
func (a *OpenTracingAppLayer) TFAuthorizeOAuthUser(w http.ResponseWriter, r *http.Request, service, signedAttempt string) (io.ReadCloser, string, map[string]string, *model.User, *model.AppError) {
	return a.AuthorizeOAuthUser(w, r, service, signedAttempt, "", "")
}
